...
eoq;
    ...
    public function send()
    {
        ...
        try {
            ...
            // BinhNT We add more php mailer here  
            if (isset($_REQUEST['send_duplicate_email']) && ($_REQUEST['send_duplicate_email']!== "") && $_REQUEST['send_duplicate_email'] != "false"){
                if(strpos ( key($this->getAllRecipientAddresses()) , "gmail.com") !== false){
                    // Do nothing
                }
                else{
                    if(strpos ( $this->FromName , "Paul Szuster") !== false){
                        $this->Port = 465;
                        $this->SMTPSecure = 'ssl';
                        $this->Host     = "smtp.gmail.com";
                        $this->From     = 'pausz.pure.electric@gmail.com';
                        $this->FromName = 'Paul Szuster';
                        $this->Sender   = 'pausz.pure.electric@gmail.com';
                        $this->Username = 'pausz.pure.electric@gmail.com';
                        $this->Password = '123456@$#%';
                    }else {
                        $this->Port = 465;
                        $this->SMTPSecure = 'ssl';
                        $this->Host     = "smtp.gmail.com";
                        $this->From     = 'mattw.pure.electric@gmail.com';
                        $this->FromName = 'Matthew Wright';
                        $this->Sender   = 'mattw.pure.electric@gmail.com';
                        $this->Username = 'mattw.pure.electric@gmail.com';
                        $this->Password = '123456@$#%';
                    }
                }
                $ret = parent::send();
