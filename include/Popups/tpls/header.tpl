...
{*
/**
*dung code -- add library tinymce.min.js
*/
*}
{if $module == 'pe_smstemplate'}
	...
	<script type="text/javascript" src="{sugar_getjspath file='custom/modules/pe_smstemplate/pe_smstemplate.js'}"></script>
{/if}
{$STYLE_JS}
