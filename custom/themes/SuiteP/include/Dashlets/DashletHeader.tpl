{* thienpb code *}
{sugar_getscript file='include/Chosen/chosen.jquery.js'}
{sugar_getscript file='include/Chosen/docsupport/prism.js'}
{sugar_getscript file='include/Chosen/docsupport/init.js'}
<link href="include/Chosen/docsupport/prism.css" rel="stylesheet" type="text/css"/>
<link href="include/Chosen/chosen.css" rel="stylesheet" type="text/css"/>
            ...
            <tr>
                <td class="dashlet-title" colspan="2">
                    <h3>
                       ...
                       {if $DASHLET_TITLE|lower != "reports" && $DASHLET_TITLE|lower != "my calendar" }
                            <a class="button primary" target="_blank" href="/index.php?action=index&module={$DASHLET_MODULE}">{$DASHLET_MODULE|replace:'_':' '} Module</a>
                        {/if}
                    </h3>        
                </td>
