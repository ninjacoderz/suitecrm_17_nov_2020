...
$tesla_quote_id = $_GET['tesla_quote_id'];

//$tesla_quote_id = "78974";
$url = 'https://crm.solargain.com.au/APIv2/quotes/'.$tesla_quote_id;
...
curl_setopt($curl, CURLOPT_HTTPHEADER, array(
        ...
        "Referer: https://crm.solargain.com.au/quote/edit/".$tesla_quote_id,
...
//Thienpb code - Update option sg (solargain info, and travel)
...
$RoofType_arr = array('Other'=>1,'Tin'=>2,'Tile'=>3,'klip_loc'=>4,'Concrete'=>5,'Trim_Deck'=>6,'Insulated'=>7,'Asbestos'=>8,'Ground_Mount'=>9,'Terracotta'=>10);
$RoofType = $quote_decode->Install->RoofType;
$RoofType->ID = $RoofType_arr[urldecode($_GET['roof_type'])];
$data = array(
    "ID"=>$install,
...
$headers[] = "Referer: https://crm.solargain.com.au/quote/edit/".$tesla_quote_id;
...
//dung code - upload file for Citipower Powercor push sogargain
    ...
    //                 curl_setopt($ch, CURLOPT_URL, "https://crm.solargain.com.au/APIv2/quotes/".$tesla_quote_id."/files/" .$id_file_image_exist);
    ...
    //                 curl_setopt($ch, CURLOPT_URL, "https://crm.solargain.com.au/APIv2/quotes/".$tesla_quote_id."/files");
    //                 curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    ...
    //             'Url'      => "",
    //         );
    //         curl_setopt($ch, CURLOPT_URL, "https://crm.solargain.com.au/APIv2/quotes/" .$tesla_quote_id."/upload");
    //         curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    ...
    //             curl_setopt($ch, CURLOPT_URL, "https://crm.solargain.com.au/APIv2/quotes/".$tesla_quote_id."/files/" .$id_file_image_meterbox ."/category/6");
    //             curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    //             curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "GET");
...
//dung code - upload all file image into solargain - thienpb comment because not use
    ...
    //         $file_type = strtolower(substr($file,-3));
    ...
    //                 curl_setopt($ch, CURLOPT_URL, "https://crm.solargain.com.au/APIv2/quotes/".$tesla_quote_id."/files/" .$id_file_image_meterbox ."/category/3");
    //                 curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    //                 curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "GET");
    ...
    //                 curl_setopt($ch, CURLOPT_URL, "https://crm.solargain.com.au/APIv2/quotes/".$tesla_quote_id."/files/" .$id_file_image_meterbox ."/category/1");
    //                 curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    //                 curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "GET");
    ...
    //                 curl_setopt($ch, CURLOPT_URL, "https://crm.solargain.com.au/APIv2/quotes/".$tesla_quote_id."/files/" .$id_file_image_meterbox ."/category/2");
    //                 curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    //                 curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "GET");
...
$url = 'https://crm.solargain.com.au/APIv2/quotes/' .$tesla_quote_id .'/pdf?random=0.28232019025497257';
$ch = curl_init();
...
if($lead->id !=''){
    ...
    //save pdf file
    $file = $folder.'/Tesla_Quote_#'.$tesla_quote_id ."_" .$dateAUS .".pdf";
    if($file!=''){
