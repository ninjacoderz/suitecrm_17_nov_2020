  ...
  array (
    ...
    array (
      ...
      array (
        ...
        1 => 
        array (
          'file' => 'custom/modules/Calls/CustomCallEditView.js',
        ),
        2 => 
        array (
          'file' => 'custom/modules/Calls/CustomCalls.js',
        ),
      ),
      'maxColumns' => '2',
      'form' => 
      array (
        ...
        array (
          ...
          3 => 
          array (
            'customCode' => '{if $fields.status.value != "Held"}<input title="{$APP.LBL_CLOSE_AND_CREATE_BUTTON_TITLE}" id="CLOSE_CREATE_HEADER" accessKey="{$APP.LBL_CLOSE_AND_CREATE_BUTTON_KEY}" class="button" onclick="SUGAR.calls.fill_invitees();  document.EditView.action.value=\'Save\'; document.EditView.return_module.value=\'Calls\';  document.EditView.isSaveAndNew.value=true; document.EditView.return_action.value=\'EditView\'; document.EditView.return_id.value=\'{$fields.id.value}\'; formSubmitCheck();" type="button" name="button" value="Close And Duplicate">{/if}',
          ),
        ),
        'buttons_footer' => 
        array (
