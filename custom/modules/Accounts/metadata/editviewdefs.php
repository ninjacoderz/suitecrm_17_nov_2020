    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            'name' => 'sanden_installer_tbc_c',
            'label' => 'LBL_SANDEN_INSTALLER_TBC',
          ),
          1 => 
          array (
            'name' => 'sanden_electrician_tbc_c',
            'label' => 'LBL_SANDEN_ELECTRICIAN_TBC',
          ),
        ),
        11 => 
        array (
          0 => 
          array (
            'name' => 'daikin_installer_tbc_c',
            'label' => 'LBL_DAIKIN_INSTALLER_TBC',
          ),
          1 => '',
        ),
        12 => 
        ...
        array (
          0 => 
          array (
            'name' => 'sanden_plumber_c',
            'label' => 'LBL_SANDEN_PLUMBER_C',
          ),
          1 => 
          array (
            'name' => 'sanden_electrician_c',
            'label' => 'LBL_SANDEN_ELECTRICIAN_C',
          ),
        ),
        14 => 
        array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            'name' => 'base_install_rate_c',
            'label' => 'LBL_BASE_INSTALL_RATE',
          ),
          1 => 
          array (
            'name' => 'wall_bracket_c',
            'label' => 'LBL_WALL_BRACKET ',
          ),
        ),
        1 => 
        array (
        ...
        array (
          0 => 
          array (
            'name' => 'additional_piping_c',
            'label' => 'LBL_ADDITIONAL_PIPING',
          ),
          1 => 
          array (
            'name' => 'entry_for_wall_bracket_c',
            'label' => 'LBL_ENTRY_FOR_WALL_BRACKET',
          ),
        ),
      ),
      'lbl_editview_panel3' => 
      array (
        ...
        array (
          ...
          array (
            ...
            'studio' => 'visible',
            'label' => 'LBL_SYSTEM_OWNER_TYPE_C',
          ),
          1 => 
          array (
            'name' => 'good_services_tax_c',
            'label' => 'LBL_GOOD_SERVICES_TAX_C',
          ),
        ),
        1 => 
        array (
          ...
          array (
            ...
            'studio' => 'visible',
            'label' => 'LBL_REGISTERED_FOR_GST_C',
          ),
          1 => 
          array (
            'name' => 'main_business_location_c',
            'label' => 'LBL_MAIN_BUSINESS_LOCATION_C',
          ),
        ),
        2 => 
        array (
          ...
          array (
            'name' => 'entity_name_c',
            'label' => 'LBL_ENTITY_NAME_C',
          ),
          1 => 
          array (
            'name' => 'business_name_c',
            'label' => 'LBL_BUSINESS_NAME_C',
          ),
        ),
        3 => 
        array (
          ...
          array (
            'name' => 'entity_type_c',
            'label' => 'LBL_ENTITY_TYPE_C',
          ),
          1 => 
          array (
            'name' => 'trading_name_c',
            'label' => 'LBL_TRADING_NAME_C',
          ),
        ),
        4 => 
        array (
