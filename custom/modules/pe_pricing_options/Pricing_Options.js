...
function init_table_solar() {
    
    var panel_type = ['','Jinko Tiger N-type Mono 370','Q CELLS Q.MAXX-G3 385W',/*'Jinko 370W Cheetah Plus JKM370M-66H''Jinko 330W Mono PERC HC','Q CELLS Q.MAXX-G2 350W','Longi Hi-MO X 350W''Q CELLS Q.MAXX 330W''Q CELLS Q.PEAK DUO G6+ 350W','Sunpower P3 325 BLACK'*/'Sunpower P3 370 BLACK',/*'Sunpower X22 360W',*/'Sunpower Maxeon 3 400W'/*'Sunpower Maxeon 2 350','Sunpower Maxeon 3 395'*/];
    ...
    $("#save_options").on("click",function(){
        save_values('Solar-PV-Pricing','solar_pv_pricing_input');
    })
    parseandsetvalue();
