...
while ($row = $db->fetchByAssoc($ret)) {
    $data_return = array (
        ...
        'street_address' => $quote->install_address_c,
        'postcode_address' => $quote->install_address_postalcode_c,
        'state_address' => $quote->install_address_state_c,
        'phone_number' => $account->mobile_phone_c,
        'email' => $account->email1,
        'suburb_address' => $quote->install_address_city_c,
