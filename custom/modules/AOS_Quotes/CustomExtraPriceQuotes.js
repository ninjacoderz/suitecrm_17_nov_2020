     ...
     SUGAR.updateQuotePriceToSolargain = function(elem) {
        ...
        for(var i = 1; i<=6 ;i++){
            ...
            if($("#base_price_"+i).val() !=''){
                ...
                }else if(option_panel_type == 'Sunpower Maxeon 3 400' && (option_inverter_type == 'S Edge 3' || option_inverter_type == 'S Edge 5' || option_inverter_type == 'S Edge 6' || option_inverter_type == 'S Edge 6' || option_inverter_type == 'S Edge 8' || option_inverter_type == 'S Edge 8 3P' || option_inverter_type == 'S Edge 10') ){
