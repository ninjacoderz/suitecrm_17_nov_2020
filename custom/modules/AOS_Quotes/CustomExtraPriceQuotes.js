$(function () {
    ...
    $("#inverter_type_1").closest('tr').find("td").eq(0).append("</br><button class='button primary' type='button' id='max_panels' name='max_panels'>MAX PANELS</button>")
...
///// DECLARE FUNCTION /////
    ...
    function getBasePrice(panel_type,inverter_type,total_panel){
        ...
        // if(panel_type == 'Sunpower Maxeon 3 395'){
        //     panel_type = 'Sunpower Maxeon 2 350';
        // }
    ...
    function getSuggestedPanel(panel_type,inverter_type,total_panel,check=false){
        ...
        // if(panel_type == 'Sunpower Maxeon 3 395' && !check){
        //     panel_type = 'Sunpower Maxeon 2 350';
        // }
