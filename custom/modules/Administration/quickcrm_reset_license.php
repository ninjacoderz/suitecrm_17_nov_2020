...
$administration->saveSetting('QuickCRM', 'keyverified', '');
$administration->saveSetting('QuickCRM', 'key', '');
header("Location: index.php?module=Administration&action=usersquickcrm");
