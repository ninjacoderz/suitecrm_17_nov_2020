  ...
  array (
    ...
    array (
      ...
      array (
        ...
        1 => 
        array (
          'file' => 'custom/modules/Calls/customDetailCalls.js',
        ),
      ),
      'tabDefs' => 
      array (
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          array (
            'name' => 'CONTACT_NAME',
            'customCode' => '<a href="index.php?module=Contacts&amp;action=DetailView&amp;record={$fields.contact_id.value}" class="tabDetailViewDFLink">{$fields.contact_name.value}</a>',
