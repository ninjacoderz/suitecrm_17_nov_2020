    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            'name' => 'pcoc_cert_wording_c',
            'studio' => 'visible',
            'label' => 'LBL_PCOC_CERT_WORDING_C',
          ),
          1 => 
          array (
            'name' => 'ces_cert_wording_c',
            'studio' => 'visible',
            'label' => 'LBL_CES_CERT_WORDING_C',
          ),
        ),
        25 => 
        array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            'name' => 'sanden_shipping_bill_c',
            'label' => 'LBL_SANDEN_SHIPPING_BILL_C',
          ),
          1 => 
          array (
            'name' => 'sanden_stcs_c',
      ...
      array (
        ...
        array (
          0 => 
          array (
            'name' => 'next_payment_state_c',
            'label' => 'LBL_NEXT_PAYMENT_STATE_C',
          ),
          1 => '',
        ),
      ),
