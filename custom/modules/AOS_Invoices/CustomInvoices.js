...
//tran_tu code
        ...
        YAHOO.util.Event.addListener("delivery_date_c", "change", function(){
        ...
        if(module_sugar_grp1 == 'AOS_Invoices'){
            ...
            $("div[data-label='LBL_INSTALL_ADDRESS']").append(
                '<a style="float: right;cursor:pointer;" id="open_map_install" title="open map" onClick=" $(document).find(\'#open_map_popup_install\').fadeToggle();"><img src="themes/SuiteP/images/map.png" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true"></a>');
        ...
        $("div[data-label='LBL_SITE_DETAIL_ADDR_']").append(
            '<a style="float: right;cursor:pointer;" id="open_map_site_install" title="open map"><img src="themes/SuiteP/images/map.png" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true"></a>');
    ...
    $( document ).ready(function() {
        ...
        if(module_sugar_grp1 == 'AOS_Invoices') {
            ...
            if($("#installation_calendar_id_c").val() != ''){
                ...
                $("#installation_calendar_id_c").after('<p id="link_installer_calendar">Link to Admin :<a href="https://calendar.pure-electric.com.au/#/installation-booking/'+$("#installation_calendar_id_c").val().trim()+'/peadmin">https://calendar.pure-electric.com.au/#/installation-booking/'+$("#installation_calendar_id_c").val().trim()+'/peadmin</a></p>');
                if($("#billing_account_id").val().trim() != '')
                    ...
                    <a href="https://calendar.pure-electric.com.au/#/installation-booking/'+$("#installation_calendar_id_c").val().trim()+'/client">https://calendar.pure-electric.com.au/#/installation-booking/'+$("#installation_calendar_id_c").val().trim()+'/client</a>')
                if($("#account_id_c").val().trim() != '')
                    ...
                    <a href="https://calendar.pure-electric.com.au/#/installation-booking/'+$("#installation_calendar_id_c").val().trim()+'/electrician/'+$("#account_id_c").val().trim()+'">https://calendar.pure-electric.com.au/#/installation-booking/'+$("#installation_calendar_id_c").val().trim()+'/electrician/'+$("#account_id_c").val().trim()+'</a>')
                if($("#account_id1_c").val().trim() != '')
                    ...
                    <a href="https://calendar.pure-electric.com.au/#/installation-booking/'+$("#installation_calendar_id_c").val().trim()+'/plumber/'+$("#account_id1_c").val().trim()+'">https://calendar.pure-electric.com.au/#/installation-booking/'+$("#installation_calendar_id_c").val().trim()+'/plumber/'+$("#account_id1_c").val().trim()+'</a>')
            }
