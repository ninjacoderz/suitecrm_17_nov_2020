<?php
$data_post = array(
    'serial' => $_REQUEST['meter_number_c'],
    'meterQuoteState' =>  $_REQUEST['meterQuoteState'],
    'token' => '',
);
$JSONEncode = json_encode($data_post);
$ch = curl_init();

curl_setopt($ch, CURLOPT_URL, "https://quote.globirdenergy.com.au/api/Quote/ElectricityQuoteByMeter/");
