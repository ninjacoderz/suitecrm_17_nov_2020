...
class ViewConvertLead extends SugarView
{
    ...
    public function display()
    {
        ...
        {
            if(!isset($beanList[$module]) && $module != "OpportunitiesSanden" &&
                $module != "OpportunitiesDaikin" &&
                $module != "OpportunitiesSolar" &&
                $module != "OpportunitiesMathven"
            )
            {
                continue;
            }

            if($module == "OpportunitiesSanden"){
                $bean = "Opportunity";
            }
            else if($module == "OpportunitiesDaikin"){
                $bean = "Opportunity";
            }
            else if($module == "OpportunitiesSolar"){
                $bean = "Opportunity";
            }
            else if($module == "OpportunitiesMathven"){
                $bean = "Opportunity";
            }
            else $bean = $beanList[$module];
            ...
            foreach($focus->field_defs as $field => $def)
            {
                if(isset($vdef[$ev->view]['copyData']) && $vdef[$ev->view]['copyData'])
                {
                    ...
                    if ($module == "Accounts" && $field == 'mobile_phone_c')
                    {
                        $focus->mobile_phone_c = $this->focus->phone_mobile;
                    }
    ...
    )
    {
        ...
        //dungnp -- logic when convert fromd lead source = solargain
        $jsOut .= "
            if($('#Contactslead_source').val() == 'Solargain'){
                $('#convert_create_OpportunitiesSolar').val('true');
                $('#newOpportunitiesSolar').trigger('click');
                $('#OpportunitiesSolarsales_stage').val('Negotiation/Review');
            }
        ";
