...
class LeadsViewDetail extends ViewDetail {
 	...
 	function display(){
		...
		echo '<link rel="stylesheet" type="text/css" href="' . getVersionedPath('custom/include/fancybox/jquery.fancybox.css') . '" />';
		echo '<script type="text/javascript" src="' . getVersionedPath('custom/include/fancybox/jquery.fancybox.pack.js') . '"></script>';		
