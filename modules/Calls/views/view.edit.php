...
class CallsViewEdit extends ViewEdit
{
    ...
    public function display()
    {
        ...
        echo $template_electrical->fetch('custom/modules/Calls/Dialog_Call.tpl');

        //VUT-S- render subpanel internal notes >> copy on Quote's 
            require_once ('include/SubPanel/SubPanelTiles.php');
            $subpanel = new SubPanelTiles($this->bean, $this->module);
            $subpanel_internal_notes = $subpanel->subpanel_definitions->layout_defs['subpanel_setup']['calls_pe_internal_note_1'];
            $subpanel->subpanel_definitions->layout_defs['subpanel_setup'] = ['calls_pe_internal_note_1' => $subpanel_internal_notes ];
            echo '<form id="DetailView" method="POST" name="DetailView">
                        <input hidden name="module" value="Calls" />
        ...
        //VUT-E- render subpanel internal notes
    }
}
