...
$dictionary['Account'] = array(
	...
	// BinhNT
        'po_purchase_order' => array(
            'name' => 'po_purchase_order',
            'vname' => 'LBL_PO_PURCHASE_ORDER',
            'type' => 'link',
            'relationship' => 'account_po_purchase_order',
...
,
    ...
    ,
        ...
        'account_po_purchase_order' => array(
            'lhs_module' => 'Accounts',
            'lhs_table' => 'accounts',
            'lhs_key' => 'id',
