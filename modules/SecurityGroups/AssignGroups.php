...
function send_massassign(mode, no_record_txt, start_string, end_string, del) {
	...
	if(document.MassAssign_SecurityGroups.massassign_group.selectedIndex == 0 && document.MassAssign_SecurityGroups.massassign_status.selectedIndex == 0) {
    ...
    if( document.MassAssign_SecurityGroups.massassign_status != undefined && document.MassAssign_SecurityGroups.massassign_status.selectedIndex > 0 && module_sugar_grp1 == "AOS_Invoices" ){
        for( var i = 0; i < ar.length ; i++){
            ...
            var result = $.getJSON("index.php", {
                ...
                field: "status",
                current_module: module_sugar_grp1,
                id: ar[i],
                value: document.MassAssign_SecurityGroups.massassign_status.value,
                view: view,
                parent_type: "",
                to_pdf: true
            });
...
EOQ;
		...
		<tr>
		<td>Status:</td>
        <td><select name="massassign_status" id="massassign_status" tabindex='1'>
            <option label="" value="" selected="selected">--None--</option>
            <option label="Unpaid" value="Unpaid" >Unpaid</option>
            <option label="Part paid" value="Partpaid">Part paid</option>
            <option label="Deposit Paid" value="Deposit_Paid">Deposit Paid</option>
            <option label="Progress Paid" value="Progress_Paid">Progress Paid</option>
            <option label="Variation Unpaid" value="Variation_Unpaid">Variation Unpaid</option>
            <option label="STC&amp;VEEC Unpaid" value="STC_VEEC_Unpaid">STC&amp;VEEC Unpaid</option>
            <option label="STC Unpaid" value="STC_Unpaid">STC Unpaid</option>
            <option label="Solar VIC Unpaid" value="Solar_VIC_Unpaid">Solar VIC Unpaid</option>
            <option label="VEEC Unpaid" value="VEEC_Unpaid">VEEC Unpaid</option>
