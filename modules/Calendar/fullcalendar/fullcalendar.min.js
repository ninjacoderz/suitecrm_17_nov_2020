...
! function(t) {
    ...
    me.mixin({
        ...
        fgSegHtml: function(t, e) {
            var n, i, r = this.view,
                ...
                c = "";
            return u.unshift("fc-day-grid-event", "fc-h-event"), t.isStart && (n = this.getEventTimeText(s), n && (c = '<span class="fc-time">' + tt(n) + "</span>")), i = '<span class="fc-title">' + ((s.title || "") || "&nbsp;") + "</span>", '<a class="' + u.join(" ") + '"' + (s.url ? ' href="' + tt(s.url) + '"' : "") + (d ? ' style="' + d + '"' : "") + '><div class="fc-content">' + (this.isRTL ? i + " " + c : c + " " + i) + "</div>" + (l ? '<div class="fc-resizer fc-start-resizer" />' : "") + (a ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
        },
        ...
        renderSegPopoverContent: function(e, n, i) {
            var r, s = this.view,
                ...
                a = t('<div class="fc-header ' + s.widgetHeaderClass + '"><span class="fc-close ' + (o ? "ui-icon ui-icon-closethick" : "fc-icon fc-icon-x") + '"></span><span class="fc-title">' + (l) + '</span><div class="fc-clear"/></div><div class="fc-body ' + s.widgetContentClass + '"><div class="fc-event-container"></div></div>'),
    ...
    ye.mixin({
        ...
        fgSegHtml: function(t, e) {
            var record_id = t.event.id;
            var color_type ;
            // jQuery.ajax({
            //     url: "index.php?entryPoint=createMettingWHLog&record_id=" + record_id +"&set_color=color_meeting",
            //     async:false
            // }).done(function(data) {
            //     color_type = data;
            // });
            ...
            if(o['title'].indexOf("Arrival") >= 0){
                if(o['module'] == 'Meetings') {
                    var c ="background-color:rgb(209, 29, 149);border-color: rgb(135, 113, 156);color: black";  
                }else{
                    var c ="background-color:#f95858;border-color: rgb(113, 156, 115);color: black";  
                }
                                  
            }else if(o['title'].indexOf("Dispatch") >= 0){
               
                if(o['module'] == 'Meetings') {
                    var c ="rgba(70, 29, 209, 0.66);border-color: rgb(135, 113, 156);color: black"; 
                }else{
                    var c ="rgb(54, 195, 180);border-color: rgb(113, 156, 115);color: black";  
                }
            }else if(o['title'].indexOf("Sanden") >= 0){
                
                if(o['module'] == 'Meetings') {
                    var c ="background-color:green;border-color: rgb(135, 113, 156);color: rgb(229, 229, 229)";
                }else{
                    var c ="background-color:rgb(155, 179, 44);border-color: rgb(113, 156, 115);color: black";  
                }
            }else if(o['title'].indexOf("Daikin") >= 0){
               
                if(o['module'] == 'Meetings') {
                    var c ="background-color:rgb(29, 34, 209);border-color: rgb(135, 113, 156);color: rgb(229, 229, 229)";
                }else{
                    var c ="background-color:rgb(148, 28, 25);border-color: rgb(113, 156, 115);color: black";  
                }
            }else if(o['title'].indexOf("Solargain") >= 0){ 
                if(o['module'] == 'Meetings') {
                    var c ="background-color:rgb(227 255 98);border-color: rgb(135, 113, 156);color: black";
                }else{
                    var c ="background-color:rgb(40, 109, 34);border-color: rgb(113, 156, 115);color: black";  
                }
            }else{
                var c =nt(this.getSegSkinCss(t));
            }
                 
            return d.unshift("fc-time-grid-event", "fc-v-event"), s.isMultiDayEvent(o) ? (t.isStart || t.isEnd) && (n = this.getEventTimeText(t), i = this.getEventTimeText(t, "LT"), r = this.getEventTimeText(t, null, !1)) : (n = this.getEventTimeText(o), i = this.getEventTimeText(o, "LT"), r = this.getEventTimeText(o, null, !1)), '<a class="' + d.join(" ") + '"' + (o.url ? ' href="' + tt(o.url) + '"' : "") + (c ? ' style="' + c + '"' : "") + '><div class="fc-content">' + (n ? '<div class="fc-time" data-start="' + tt(r) + '" data-full="' + tt(i) + '"><span>' + tt(n) + "</span></div>" : "") + (o.title ? '<div class="fc-title">' + (o.title) + "</div>" : "") + '</div><div class="fc-bg"/>' + (u ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
