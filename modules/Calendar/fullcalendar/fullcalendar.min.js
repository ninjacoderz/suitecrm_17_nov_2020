    ...
    ye.mixin({
        ...
        fgSegHtml: function(t, e) {
            ...
            if(o['title'].indexOf("Arrival") >= 0){
                ...
                if(o['module'] == 'Meetings') {
                    var c ="background-color:#1d22d1;border-color: rgb(135, 113, 156);color: rgb(229, 229, 229)";
                }else{
                ...
                if(o['module'] == 'Meetings') {
                    var c ="background-color:#cf0707;border-color: rgb(135, 113, 156);color: rgb(229, 229, 229)";
                }else{
