...
function insertProductLine(tableid, groupid) {
  ...
  c.innerHTML = "<input type='text' name='product_serial_number[" + prodln + "]' id='product_serial_number" + prodln + "' maxlength='50' value='' title='' tabindex='116' class='product_list_price'>";


  var d = x.insertCell(5);
  d.innerHTML = "<input type='text' name='product_ordered[" + prodln + "]' id='product_ordered" + prodln + "'  maxlength='50' value='' title='' tabindex='116' class='product_ordered' />";

  var e = x.insertCell(6);
  e.innerHTML = "<input type='text' name='product_shipped[" + prodln + "]' id='product_shipped" + prodln + "'  maxlength='50' value='' title='' tabindex='116' class='product_shipped' />";
...
function insertProductHeader(tableid){
  ...
  c.innerHTML=SUGAR.language.get(module_sugar_grp1, 'LBL_SERIAL_NUMBER');

  var d=x.insertCell(4);
  d.style.color="rgb(68,68,68)";
  d.innerHTML=SUGAR.language.get(module_sugar_grp1, 'LBL_PRODUCT_ORDERED');

  var e=x.insertCell(5);
  e.style.color="rgb(68,68,68)";
  e.innerHTML=SUGAR.language.get(module_sugar_grp1, 'LBL_PRODUCT_SHIPPED');
