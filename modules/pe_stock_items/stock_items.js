...
function insertProductLine(tableid, groupid) {
  ...
  h1.style.padding = '0';//thienpb fix

  var j = y.insertCell(1);
  j.colSpan = "3";
  j.style.color = "rgb(68,68,68)";
  j.innerHTML = "<span style='vertical-align: top;' class='product_description_label'>"  + SUGAR.language.get(module_sugar_grp1, 'LBL_PRODUCT_ORDERED') + " :&nbsp;</span>";
  j.innerHTML += "<input type='text' name='product_ordered[" + prodln + "]' id='product_ordered" + prodln + "' maxlength='50' value='' title='' tabindex='116'  class='product_ordered'>";
  j.style.padding = '0';//thienpb fix

  var k1 = y.insertCell(2);
  k1.colSpan = "3";
  k1.style.color = "rgb(68,68,68)";
  k1.innerHTML = "<span style='vertical-align: top;' class='product_description_label'>"  + SUGAR.language.get(module_sugar_grp1, 'LBL_PRODUCT_SHIPPED') + " :&nbsp;</span>";
  k1.innerHTML += "<input type='text' name='product_shipped[" + prodln + "]' id='product_shipped" + prodln + "' maxlength='50' value='' title='' tabindex='116'  class='product_shipped'>";
  k1.style.padding = '0';//thienpb fix
