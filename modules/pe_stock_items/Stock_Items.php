...
function display_lines_stock_items($focus, $field, $value, $view){
    ...
    if($view == 'EditView'){
        ...
        $html .= '<script src="modules/pe_stock_items/stock_items.js"></script>';
        if(file_exists('custom/modules/pe_stock_items/stock_items.js')){
            $html .= '<script src="custom/modules/pe_stock_items/stock_items.js"></script>';
        }
	//BinhNT
        if($focus->module_dir == "pe_stock_items"){
            $html .= '<script src="modules/pe_stock_items/stock_items.js"></script>';
        }
        ...
        while ($row = $focus->db->fetchByAssoc($result)) {
            ...
            if($enable_groups && ($group_id != $row['group_id'] || $i == 0)){
                ...
                $groupStart .= "<td class='tabDetailViewDL' colspan='7' style='text-align: left;padding:2px 5px;font-weight:bold;'>".$group_item->name."</td>";
                $groupStart .= "</tr>";
            ...
            if($line_item->product_id != '0' && $line_item->product_id != null){
                if($productCount == 0)
                {
                    ...
                    $product .= "<td width='5%' class='tabDetailViewDL' style='text-align: left;padding:2px;' scope='row'>".$mod_strings['LBL_PRODUCT_QUANITY']."</td>";
                    $product .= "<td width='20%' class='tabDetailViewDL' style='text-align: left;padding:2px;' scope='row'>".$mod_strings['LBL_PRODUCT_NAME']."</td>";
                    $product .= "<td width='14%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_SERIAL_NUMBER']."</td>";
                    $product .= "<td width='8%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_LIST_PRICE']."</td>";
                    $product .= "<td width='8%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_DISCOUNT_AMT']."</td>";
                    $product .= "<td width='8%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_UNIT_PRICE']."</td>";
                    $product .= "<td width='8%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_VAT']."</td>";
                    $product .= "<td width='8%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_VAT_AMT']."</td>";
                    $product .= "<td width='8%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_PRODUCT_TOTAL_PRICE']."</td>";
                ...
                $product .= "<tr>";
                //$product_note = wordwrap($line_item->item_description,100,"<br />\n");
                $product .= "<td class='tabDetailViewDF' style='text-align: left; padding:2px;'>".++$productCount."</td>";
                $product .= "<td class='tabDetailViewDF' style='padding:2px;'>".stripDecimalPointsAndTrailingZeroesStockItems(format_number($line_item->product_qty),$sep[1])."</td>";
                $product .= "<td class='tabDetailViewDF' style='padding:2px;'><a target='_blank' href='index.php?module=pe_stock_items&action=EditView&record=".$line_item->id."' class='tabDetailViewDFLink'>".$line_item->name."</a></td>";
                $product .= "<td class='tabDetailViewDF' style='text-align: right; padding:2px;'>".$line_item->serial_number."</td>";
                ...
                $product .= "<td class='tabDetailViewDF' style='text-align: right; padding:2px;'>".get_discount_string_stock_items($line_item->discount, $line_item->product_discount, $params, $locale, $sep)."</td>";
                ...
                $service .= "<td class='tabDetailViewDF' style='text-align: right; padding:2px;'>".get_discount_string_stock_items($line_item->discount, $line_item->product_discount, $params, $locale, $sep)."</td>";
...
function stripDecimalPointsAndTrailingZeroesStockItems($inputString,$decimalSeparator)
{
    return preg_replace('/'.preg_quote($decimalSeparator).'[0]+$/','',$inputString);
}

function get_discount_string_stock_items($type, $amount, $params, $locale, $sep){
...
function display_shipping_vat_stock_items($focus, $field, $value, $view){
