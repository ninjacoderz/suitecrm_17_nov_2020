...
$(document).ready(function(){
    if ($('#link_to_warehouse_log_c').html() != "") {
        $('#link_to_warehouse_log_c').append('<a target="_blank" href="/index.php?module=pe_warehouse_log&action=EditView&record=' + $('#link_to_warehouse_log_c').html() + '"> Open Link</a>')
    }
})