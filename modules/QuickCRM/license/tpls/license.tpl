...
{/literal}{/if}{literal}
	...
	function filter_users(str,JQselect){
			JQselect.each(function(indx, element){
	...
	function add_search(){
        $('#unlicensed_users_td').prepend('<input type="text" id="search_unlicensed_users" placeholder="{/literal}{$APP.LBL_SEARCH}{literal}" style="margin-bottom:10px;width:190px">');
        $('#licensed_users_td').prepend('<input type="text" id="search_licensed_users" placeholder="{/literal}{$APP.LBL_SEARCH}{literal}" style="margin-bottom:10px;width:190px">');
		$('#search_unlicensed_users').on('keyup', function(){
			filter_users($(this).val(),$('#unlicensed_users option'));
			filter_users($(this).val(),$('select[name="unlicensed_users[]"] option'));
		});
		$('#search_licensed_users').on('keyup', function(){
			filter_users($(this).val(),$('#licensed_users option'));
			filter_users($(this).val(),$('select[name="licensed_users[]"] option'));
		});
	}
