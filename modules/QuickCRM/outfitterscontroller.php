...
if($_REQUEST['method'] == 'validate') {
    QOutfittersLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    QOutfittersLicense::change();
} else if($_REQUEST['method'] == 'add') {
    QOutfittersLicense::add();
    ...
    $validate_license = QOutfittersLicense::isValid($currentModule,$user_id,true);
    ...
    if($validate_license !== true) {
        ...
        $validated = QOutfittersLicense::doValidate($currentModule);
