...
function display_lines($focus, $field, $value, $view)
{
	...
	//BinhNT
        if($focus->module_dir == "PO_purchase_order"){
            $html .= '<script src="modules/PO_purchase_order/line_items.js"></script>';
        }

        if($focus->module_dir == "AOS_Invoices"){
            $html .= '<script src="modules/AOS_Invoices/line_items.js"></script>';
        }
