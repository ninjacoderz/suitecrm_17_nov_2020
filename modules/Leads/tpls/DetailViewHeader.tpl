...
{assign var=preForm value="<table width='100%' border='1' cellspacing='0' cellpadding='0' style='display:none;' class='converted_account'><tr><td><table width='100%'><tr><td>"}
...
{assign var=preForm value=$preForm|cat:"<a target='_blank' href='index.php?module=Contacts&action=EditView&record="}
{assign var=preForm value=$preForm|cat:$bean->contact_id}
{assign var=preForm value=$preForm|cat:"'>[E] "}
...
{assign var=preForm value=$preForm|cat:"<a target='_blank' href='index.php?module=Accounts&action=EditView&record="}
...
{assign var=preForm value=$preForm|cat:"<a target='_blank' href='index.php?module=Opportunities&action=EditView&record="}
...
{assign var=preForm value=$preForm|cat:"</td><td>"}
{*
{if isset($bean->time_request_design_c) && !empty($bean->time_request_design_c)}
    {assign var=displayPreform value=true}
    {if isset($bean->time_sent_to_client_c) && !empty($bean->time_sent_to_client_c)}
        {assign var=preForm value=$preForm|cat:"Solar Design Sent"}
    {else}
        {assign var=preForm value=$preForm|cat:"Solar Design Requested"}
    {/if}
{/if}
*}
