...
$dictionary['Lead'] = array('table' => 'leads', 'audited' => true, 'unified_search' => true, 'full_text_search' => true, 'unified_search_default_enabled' => true, 'duplicate_merge' => true,
    'comment' => 'Leads are persons of interest early in a sales cycle', 'fields' => array(
        ...
        'proposed_plumber_acccount_id' =>
            array(
                'required' => false,
                'name' => 'proposed_plumber_acccount_id',
                'vname' => '',
                'type' => 'id',
                'massupdate' => 0,
                'comments' => '',
        ...
        'proposed_plumber_acccount' =>
            array(
                'required' => false,
                'source' => 'non-db',
                'name' => 'proposed_plumber_acccount',
                'vname' => 'LBL_PROPOSED_PLUMBER_ACCOUNT',
                'type' => 'relate',
                'massupdate' => 0,
                'comments' => '',
                'help' => '',
                ...
                'reportable' => 1,
                'len' => '255',
                'id_name' => 'proposed_plumber_acccount_id',
                'ext2' => 'Accounts',
                'module' => 'Accounts',
                'quicksearch' => 'enabled',
                'studio' => 'visible',
            ),
        'proposed_electrician_acccount_id' =>
            array(
                'required' => false,
                'name' => 'proposed_electrician_acccount_id',
                'vname' => '',
                'type' => 'id',
                'massupdate' => 0,
                'comments' => '',
        ...
        'proposed_electrician_acccount' =>
            array(
                'required' => false,
                'source' => 'non-db',
                'name' => 'proposed_electrician_acccount',
                'vname' => 'LBL_PROPOSED_ELECTRICIAN_ACCOUNT',
                'type' => 'relate',
                'massupdate' => 0,
                'comments' => '',
                'help' => '',
                ...
                'reportable' => 1,
                'len' => '255',
                'id_name' => 'proposed_electrician_acccount_id',
                'ext2' => 'Accounts',
                'module' => 'Accounts',
                'quicksearch' => 'enabled',
                'studio' => 'visible',
            ),
        'proposed_daikin_installer_acccount_id' =>
            array(
                'required' => false,
                'name' => 'proposed_daikin_installer_acccount_id',
                'vname' => '',
                'type' => 'id',
                'massupdate' => 0,
                'comments' => '',
        ...
        'proposed_daikin_installer_acccount' =>
            array(
                'required' => false,
                'source' => 'non-db',
                'name' => 'proposed_daikin_installer_acccount',
                'vname' => 'LBL_PROPOSED_DAIKIN_INSTALLER_ACCOUNT',
                'type' => 'relate',
                'massupdate' => 0,
                'comments' => '',
                'help' => '',
                ...
                'reportable' => 1,
                'len' => '255',
                'id_name' => 'proposed_daikin_installer_acccount_id',
                'ext2' => 'Accounts',
                'module' => 'Accounts',
                'quicksearch' => 'enabled',
                'studio' => 'visible',
