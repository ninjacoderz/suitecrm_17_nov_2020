...
{if !empty($FIELD.INVOICE_C)}
    <div>
        <strong>{$MOD.LBL_INVOICE_C}</strong>
        <a href="index.php?module=AOS_Invoices&action=DetailView&record={$FIELD.AOS_INVOICES_ID_C}">INVOICE - {$FIELD.INVOICE_C}</a>
    </div>
{/if}
