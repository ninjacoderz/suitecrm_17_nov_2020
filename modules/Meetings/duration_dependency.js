...
$(document).ready(function(){
    if ($('#link_to_warehouse_log_c').val() != "") {
        $('#link_to_warehouse_log_c').parent().append('<br><a target="_blank" href="/index.php?module=pe_warehouse_log&action=EditView&record=' + $('#link_to_warehouse_log_c').val() + '">Open Link</a>')
    }
})