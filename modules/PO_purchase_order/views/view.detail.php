...
class PO_purchase_orderViewDetail extends ViewDetail {
     ...
     */
    function PO_purchase_orderViewDetail(){
	...
	function displayPopupHtml(){
		...
		echo '	<div id="popupDiv_ara" style="display:none;position:fixed;top: 39%; left: 41%;opacity:1;z-index:9999;background:#FFFFFF;">
				...
				if ($this->bean->po_type_c == 'sanden_supply' || $this->bean->po_type_c =='daikin_supply') {
