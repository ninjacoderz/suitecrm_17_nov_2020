...
function formatListPrice(ln){
  ...
  // BinhNT Code 
  if(document.getElementById('product_product_id' + ln).value == "4efbea92-c52f-d147-3308-569776823b19" || 
    document.getElementById('product_product_id' + ln).value == "cbfafe6b-5e84-d976-8e32-574fc106b13f"){
    document.getElementById('product_vat' + ln).value = "0.0";
  } else {
    // Do nothings
  }
