...
$dictionary['AOS_Quotes'] = array(
    ...
    'fields' => array(
        ...
        'sanden_shipping_bill' =>
        array(
            'name' => 'sanden_shipping_bill',
            'vname' => 'LBL_SANDEN_SHIPPING_BILL',
            'type' => 'varchar',
            'len' => 20,
            'inline_edit' => true,
            'importable' => 'true',
        ...
        'sanden_total_revenue' =>
        array(
            'name' => 'sanden_total_revenue',
            'vname' => 'LBL_SANDEN_TOTAL_REVENUE',
            'type' => 'varchar',
            'len' => 20,
            'inline_edit' => true,
            'importable' => 'true',
        ...
        'sanden_gprofit_percent' =>
        array(
            'name' => 'sanden_gprofit_percent',
            'vname' => 'LBL_SANDEN_GPROFIT_PERCENT',
            'type' => 'varchar',
            'len' => 20,
            'inline_edit' => true,
            'importable' => 'true',
        ...
        //VUT - S - create line item for plumber PO in Quote
        'plumber_line_items' =>
        array(
            'required' => false,
            'name' => 'plumber_line_items',
            'vname' => 'LBL_PLUMBER_LINE_ITEMS',
            'type' => 'function',
            'source' => 'non-db',
            'massupdate' => 0,
            'importable' => 'false',
            ...
            'function' =>
                array(
                    'name' => 'plumber_display_lines',
                    'returns' => 'html',
                    'include' => 'modules/AOS_Products_Quotes/Line_Items_Plumber.php'
                ),
        ),
        'plumber_total_amt' =>
        array(
        ...
        'plumber_discount_amount' =>
            array(
                'required' => false,
                'name' => 'plumber_discount_amount',
                'vname' => 'LBL_PLUMBER_DISCOUNT_AMOUNT',
                'type' => 'currency',
                'massupdate' => 0,
                'comments' => '',
                'help' => '',
        ...
        'plumber_subtotal_amount' =>
        array(
            'required' => false,
            'name' => 'plumber_subtotal_amount',
            'vname' => 'LBL_PLUMBER_SUBTOTAL_AMOUNT',
            'type' => 'currency',
            'massupdate' => 0,
            'comments' => '',
            'help' => '',
        ...
        'plumber_shipping_amount' =>
            array(
                'required' => false,
                'name' => 'plumber_shipping_amount',
                'vname' => 'LBL_PLUMBER_SHIPPING_AMOUNT',
                'type' => 'currency',
                'massupdate' => 0,
                'comments' => '',
                'help' => '',
                ...
                'function' =>
                array(
                    'name' => 'plumber_display_shipping_amount',
                    'returns' => 'html',
                    'include' => 'modules/AOS_Products_Quotes/Line_Items_Plumber.php'
                ),
            ),
        'plumber_shipping_tax_amt' =>
        array(
            'required' => false,
            'name' => 'plumber_shipping_tax_amt',
            'vname' => 'LBL_PLUMBER_SHIPPING_TAX_AMT',
            'type' => 'currency',
            'massupdate' => 0,
            'comments' => '',
            'help' => '',
            ...
            'function' =>
                array(
                    'name' => 'plumber_display_shipping_vat',
                    'returns' => 'html',
                    'include' => 'modules/AOS_Products_Quotes/Line_Items_Plumber.php'
                ),
        ),
        'plumber_shipping_tax' =>
            array(
                'required' => false,
                'name' => 'plumber_shipping_tax',
                'vname' => 'LBL_PLUMBER_SHIPPING_TAX',
                'type' => 'enum',
                'massupdate' => 0,
                'comments' => '',
                'help' => '',
        ...
        'plumber_total_amount' =>
        array(
            'required' => false,
            'name' => 'plumber_total_amount',
            'vname' => 'LBL_PLUMBER_GRAND_TOTAL',
            'type' => 'currency',
            'massupdate' => 0,
            'comments' => '',
            'help' => '',
        ...
        //VUT - E - create line item for plumber PO in Quote
        //VUT - S - create line item for electrician PO in Quote
        'electrician_line_items' =>
        array(
            'required' => false,
            'name' => 'electrician_line_items',
            'vname' => 'LBL_ELECTRICIAN_LINE_ITEMS',
            'type' => 'function',
            'source' => 'non-db',
            'massupdate' => 0,
            'importable' => 'false',
            ...
            'function' =>
                array(
                    'name' => 'electrician_display_lines',
                    'returns' => 'html',
                    'include' => 'modules/AOS_Products_Quotes/Line_Items_Plumber.php'
                ),
        ),
        'electrician_total_amt' =>
        array(
            'required' => false,
            'name' => 'electrician_total_amt',
            'vname' => 'LBL_ELECTRICIAN_TOTAL_AMT',
            'type' => 'currency',
            'massupdate' => 0,
            'comments' => '',
            'help' => '',
        ...
        'electrician_discount_amount' =>
            array(
                'required' => false,
                'name' => 'electrician_discount_amount',
                'vname' => 'LBL_ELECTRICIAN_DISCOUNT_AMOUNT',
                'type' => 'currency',
                'massupdate' => 0,
                'comments' => '',
                'help' => '',
        ...
        'electrician_subtotal_amount' =>
        array(
            'required' => false,
            'name' => 'electrician_subtotal_amount',
            'vname' => 'LBL_ELECTRICIAN_SUBTOTAL_AMOUNT',
            'type' => 'currency',
            'massupdate' => 0,
            'comments' => '',
            'help' => '',
        ...
        'electrician_shipping_amount' =>
            array(
                'required' => false,
                'name' => 'electrician_shipping_amount',
                'vname' => 'LBL_ELECTRICIAN_SHIPPING_AMOUNT',
                'type' => 'currency',
                'massupdate' => 0,
                'comments' => '',
                'help' => '',
                ...
                'function' =>
                array(
                    'name' => 'electrician_display_shipping_amount',
                    'returns' => 'html',
                    'include' => 'modules/AOS_Products_Quotes/Line_Items_Plumber.php'
                ),
            ),
        'electrician_shipping_tax_amt' =>
        array(
            'required' => false,
            'name' => 'electrician_shipping_tax_amt',
            'vname' => 'LBL_ELECTRICIAN_SHIPPING_TAX_AMT',
            'type' => 'currency',
            'massupdate' => 0,
            'comments' => '',
            'help' => '',
            ...
            'function' =>
                array(
                    'name' => 'electrician_display_shipping_vat',
                    'returns' => 'html',
                    'include' => 'modules/AOS_Products_Quotes/Line_Items_Plumber.php'
                ),
        ),
        'electrician_shipping_tax' =>
            array(
                'required' => false,
                'name' => 'electrician_shipping_tax',
                'vname' => 'LBL_ELECTRICIAN_SHIPPING_TAX',
                'type' => 'enum',
                'massupdate' => 0,
                'comments' => '',
                'help' => '',
        ...
        'electrician_tax_amount' =>
        array(
            'required' => false,
            'name' => 'electrician_tax_amount',
            'vname' => 'LBL_ELECTRICIAN_TAX_AMOUNT',
            'type' => 'currency',
            'massupdate' => 0,
            'comments' => '',
            'help' => '',
        ...
        'electrician_total_amount' =>
        array(
            'required' => false,
            'name' => 'electrician_total_amount',
            'vname' => 'LBL_ELECTRICIAN_GRAND_TOTAL',
            'type' => 'currency',
            'massupdate' => 0,
            'comments' => '',
            'help' => '',
        ...
        //VUT - E - create line item for plumber PO in Quote
        'proposed_solar_installer_acccount_id' =>
            array(
                'required' => false,
                'name' => 'proposed_solar_installer_acccount_id',
                'vname' => '',
                'type' => 'id',
                'massupdate' => 0,
                'comments' => '',
        ...
        'proposed_solar_installer_acccount' =>
            array(
                'required' => false,
                'source' => 'non-db',
                'name' => 'proposed_solar_installer_acccount',
                'vname' => 'LBL_PROPOSED_SOLAR_INSTALLER_ACCOUNT',
                'type' => 'relate',
                'massupdate' => 0,
                'comments' => '',
                'help' => '',
                ...
                'reportable' => 1,
                'len' => '255',
                'id_name' => 'proposed_solar_installer_acccount_id',
                'ext2' => 'Accounts',
                'module' => 'Accounts',
                'quicksearch' => 'enabled',
                'studio' => 'visible',
    ...
    'relationships' => array(
        ...
        'aos_quotes_emails' => array('lhs_module' => 'AOS_Quotes', 'lhs_table' => 'aos_quotes', 'lhs_key' => 'id',
