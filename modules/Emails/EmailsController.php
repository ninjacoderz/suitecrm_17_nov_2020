            ...
            if($_REQUEST['email_type'] == 'clients_calendar' || $_REQUEST['email_type'] == 'plumber_calendar' || $_REQUEST['email_type'] == 'electrician_calendar'){
                ...
                if( $_REQUEST['email_type'] == 'clients_calendar' ){
                    ...
                    // global $current_user;
                        ...
                        $body = str_replace("\$aos_invoices_billing_contact",  $str_calendar_installer_sms, $body);
                        $smsTemplate->body_c = $body;
                        $this->bean->emails_pe_smstemplate_idb  =   $smsTemplate->id;
                        $this->bean->emails_pe_smstemplate_name =  $smsTemplate->name; 
                    $this->bean->number_receive_sms = "matthew_paul_client";
                ...
                foreach($sanden_quote_input as $key=>$value) {
                    ...
                    if($value['isSend'] > 0 ) {
                        ...
                        <div class="op_header" style="width: 100%; position: inherit;" data-mce-style="width: 100%; position: inherit;">
                           ...
                           <div class="p" style="'.($value["recom_sd_option_".$key] == 1 ? "background: #4f5ea5b0" : "background: #945596").';float: right;width: 245px;/* border-radius: 0 20px 20px 0; */height: 45px;osition: relative;/* border: 1px solid #945596; */text-align: left;line-height: 45px;padding-left: 10p;font-size: 15px;" data-mce-style="'.($value["recom_sd_option_".$key] == 1 ? "background: #4f5ea5b0" : "background: #945596").';float: right;width: 245px;/* border-radius: 0 20px 20px 0; */height: 45px;osition: relative;/* border: 1px solid #945596; */text-align: left;line-height: 45px;padding-left: 10p;font-size: 15px;">
