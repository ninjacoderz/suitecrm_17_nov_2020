...
$dictionary['Email'] = array(
    ...
    'fields' => array(
        ...
        'send_duplicate_email' => array(
            'name' => 'send_duplicate_email',
            'type' => 'bool',
            'default' => false,
            'massupdate' => 0,
            'importable' => 'false',
        ...
        'number_send_sms' => 
            array (
            'name' => 'number_send_sms',
            'vname' => 'LBL_NUMBER_SEND_SMS',
            'type' => 'enum',
            'len' => 100,
            'options' => 'dom_number_send_sms',
            'inline_edit' => false,
            ),
        ...
        'number_receive_sms' => array(
            'name' => 'number_receive_sms',
            'type' => 'enum',
            'vname' => 'number_receive_sms',
            'options' => 'dom_number_receive_sms',
            'inline_edit' => false,
        ),
        'number_client' => array(
            'name' => 'number_client',
        ...
        "emails_pe_smstemplate" => array(
            'name' => 'emails_pe_smstemplate',
            'type' => 'link',
            'relationship' => 'emails_pe_smstemplate',
            'source' => 'non-db',
            'module' => 'pe_smstemplate',
            'bean_name' => 'pe_smstemplate',
            'vname' => 'LBL_SMS_TEMPLATE',
            'id_name' => 'emails_pe_smstemplate_idb',
        ),
        "emails_pe_smstemplate_name" => array(
            'name' => 'emails_pe_smstemplate_name',
            'type' => 'relate',
            'source' => 'non-db',
            'vname' => 'LBL_SMS_TEMPLATE',
            'save' => true,
            'id_name' => 'emails_pe_smstemplate_idb',
            'link' => 'emails_pe_smstemplate',
            'table' => 'pe_smstemplate',
            'module' => 'pe_smstemplate',
            'rname' => 'name',
        ),
        "emails_pe_smstemplate_idb" => array(
            'name' => 'emails_pe_smstemplate_idb',
            'type' => 'link',
            'relationship' => 'emails_pe_smstemplate',
            'source' => 'non-db',
            'reportable' => false,
