...
class registry_quickcrm extends registry_v4_1 {
   ...
   //Add get_relationships with "pagination" support
	   ...
	   $this->serviceClass->registerFunction(
		...
		$this->serviceClass->registerFunction(
		    'set_file_contents',
		    array('session'=>'xsd:string', 'module_name'=>'xsd:string',  'id'=>'xsd:string',  'field'=>'xsd:string',  'contents'=>'xsd:string', 'deleted'=>'xsd:int'),
		    array('return'=>'tns:new_set_entry_result'));
		...
		$this->serviceClass->registerFunction(
		    'generate_pdf',
		    array('session'=>'xsd:string', 'module_name'=>'xsd:string',  'id'=>'xsd:string',  'template_id'=>'xsd:string','save'=>'xsd:int'),
		    array('return'=>'tns:get_entry_result_version2'));

		$this->serviceClass->registerFunction(
		    'copy_homepage',
		    array('session'=>'xsd:string', 'id'=>'xsd:string', 'role'=>'xsd:string', 'user_id'=>'xsd:string'),
		    array('return'=>'tns:get_entry_result_version2'));
		...
		$this->serviceClass->registerFunction(
		    'Qset_document_revision',
	        array('session'=>'xsd:string','note'=>'tns:Qdocument_revision'),
	        array('return'=>'tns:new_set_entry_result'));
