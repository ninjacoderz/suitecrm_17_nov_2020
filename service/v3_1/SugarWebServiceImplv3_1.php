...
class SugarWebServiceImplv3_1 extends SugarWebServiceImplv3
{
    ...
    public function set_entry($session, $module_name, $name_value_list, $track_view = false)
    {
        ...
        // Check duplicate
        if($class_name == 'Lead'){
            $email_customer = $name_value_list[array_search('email1',array_column($name_value_list,'name'))]['value'];
            ...
            if($existed_lead){
                $return_entry_list = self::$helperObject->get_name_value_list_for_fields($lead, $return_fields);
                return array('id' => $lead->id, 'entry_list' => $return_entry_list);
            }
