...
{literal}
    <script type="text/javascript">
         ...
         */
	 //custom code
        $("body").on("click","#newOpportunities", function(){
            value = "";
            //value += $("input[name='Contactsfirst_name']").val() + " ";
            value += $("#Contactslast_name").val() + " ";
            value += $("#Contactsprimary_address_city").val() + " ";
            value += $("#Contactsprimary_address_state").val() + " ";
            value += "Other ";

            $("#Opportunitiesname").val(value);
        });

        $("body").on("click","#newOpportunitiesSanden", function(){
            value = "";
            //value += $("input[name='Contactsfirst_name']").val() + " ";
            value += $("#Contactslast_name").val() + " ";
            value += $("#Contactsprimary_address_city").val() + " ";
            ...
            $("#OpportunitiesSandenname").val(value);
        });

        $("body").on("click","#newOpportunitiesDaikin", function(){
            value = "";
            //value += $("input[name='Contactsfirst_name']").val() + " ";
            value += $("#Contactslast_name").val() + " ";
            value += $("#Contactsprimary_address_city").val() + " ";
            ...
            $("#OpportunitiesDaikinname").val(value);
        });

        $("body").on("click","#newOpportunitiesSolar", function(){
            value = "";
            //value += $("input[name='Contactsfirst_name']").val() + " ";
            value += $("#Contactslast_name").val() + " ";
            value += $("#Contactsprimary_address_city").val() + " ";
            ...
            $("#OpportunitiesSolarname").val(value);
        });
        //
        ...
        function addRemoveDropdownElement(module) {
            var firstName = $("input[name='Contactsfirst_name']").val();
            var lastName = $("input[name='Contactslast_name']").val();

            var accountText = document.getElementById('account_name');
            $("#Accountsname").val(firstName + " " + lastName)
	...
	//custom code
        function fillOutDefaultValue() {
            document.getElementById('Opportunitiesamount').value = 800;
            var today = new Date();
            var tomorrow = new Date();
            tomorrow.setDate(today.getDate()+1);
            var tomorrow_string = tomorrow.getDate() + "/" + ( tomorrow.getMonth() + 1 ) + "/" + tomorrow.getFullYear();  
            document.getElementById('Opportunitiesdate_closed').value = tomorrow_string;

            document.getElementById('OpportunitiesSandenamount').value = 800;
            document.getElementById('OpportunitiesSandendate_closed').value = tomorrow_string;

            document.getElementById('OpportunitiesDaikinamount').value = 600;
            document.getElementById('OpportunitiesDaikindate_closed').value = tomorrow_string;

            document.getElementById('OpportunitiesSolaramount').value = 700;
            document.getElementById('OpportunitiesSolardate_closed').value = tomorrow_string;
        }
