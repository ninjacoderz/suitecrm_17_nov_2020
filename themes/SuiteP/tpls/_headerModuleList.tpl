    ...
    <div class="container-fluid">
        ...
        <div class="mobile-bar">
            <ul id="toolbar" class="toolbar">
                <li class="create dropdown nav navbar-nav quickcreatetop">              
                    <form name="frm_portal_1" id="frm_portal_1" method="POST" target="_blank" action="http://message.pure-electric.com.au/">
                        <input type='hidden' name="MSID" id="MSID" value="{$PHP_SESSION_ID}">
                        <button style="background-color: #a2b2bf;height: 40px;line-height: 36px;padding-top: 0px;border: 0px;display: inline-block;font-size: 13px;color: #fff;border-radius: 3px;letter-spacing: 2px;text-align: center;text-decoration: none;cursor: pointer;">SMS Portal 1</button>
                    </form>
                </li>
                <li class="create dropdown nav navbar-nav quickcreatetop">
                    <form name="frm_portal" id="frm_portal" method="POST" target="_blank" action="http://message2.pure-electric.com.au/">
                        <input type='hidden' name="MSID" id="MSID" value="{$PHP_SESSION_ID}">
                        <button style="background-color: #a2b2bf;height: 40px;line-height: 36px;padding-top: 0px;border: 0px;display: inline-block;font-size: 13px;color: #fff;border-radius: 3px;letter-spacing: 2px;text-align: center;text-decoration: none;cursor: pointer;">SMS Portal 2</button>
                    </form>
                </li>
                ...
                <li id="quickcreatetop" class="create dropdown nav navbar-nav quickcreatetop">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="index.php?module=pe_service_case&action=EditView&return_module=pe_service_case&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="pe_service_case" label="LBL_MODULE_NAME"}</a></li>
                    </ul>
                </li>
