...
$(document).ready(function () {
    ...
    //tu-code show all calendar --thienpb fixed -- dung merge
    $('body').on('click','#show_all_calendar',function(){
        ...
        if(date_sort !== '' && typeof(date_sort) !== 'undefined') {
            ...
            var url = "index.php?module=Home&action=DynamicAction&DynamicAction=displayDashlet&sugar_body_only=1&&year="+date_sort[2]+"&month="+ date_sort[1]+"&day="+date_sort[0]+"&hour=0&id=" +dashlets_id+"&query=paul";
            ...
            dashlets_id = dashlets_id.slice(8);
            var today = new Date();
            date_sort = today.getDate() +'/'+ (today.getMonth()+1) + '/' +today.getFullYear();
            date_sort = date_sort.split('/');
            var url = "index.php?module=Home&action=DynamicAction&DynamicAction=displayDashlet&sugar_body_only=1&&year="+date_sort[2]+"&month="+ date_sort[1]+"&day="+date_sort[0]+"&hour=0&id=" +dashlets_id+"&query=paul";
            SUGAR.mySugar.retrieveDashlet(dashlets_id, url);
        }
    });
    // $('body').on('click','.click_meeting_type',function(){
    //     switch($(this).val()){
    //         case 'Daikin install' :
    //             $('#calendarContainer .fc-content-skeleton .fc-event-container .fc-content .fc-title').each(function(){
    //                 var  meeting_delivery = $(this).html()
    //                    if( meeting_delivery.includes('Daikin') == true ){
    //                         if( meeting_delivery.includes('Arrival') == true ||  meeting_delivery.includes('Dispatch') == true ){
    ...
    //             $('#calendarContainer .fc-content-skeleton .fc-event-container .fc-content .fc-title').each(function(){
    //                 var  meeting_delivery = $(this).html()
    //                    if( meeting_delivery.includes('Sanden') == true ){
    //                        if( meeting_delivery.includes('Arrival') == true ||  meeting_delivery.includes('Dispatch') == true ){
    //                         $(this).parent().parent().hide()
    //                        }else {
    //                         $(this).parent().parent().show();
    ...
    //             $('#calendarContainer .fc-content-skeleton .fc-event-container .fc-content .fc-title').each(function(){
    //                 var  meeting_delivery = $(this).html()
    //                    if( meeting_delivery.includes('Solar') == true ){
    //                         if( meeting_delivery.includes('Arrival') == true ||  meeting_delivery.includes('Dispatch') == true ){
    //                             $(this).parent().parent().hide()
    //                         }else {
    //                             $(this).parent().parent().show();
    ...
    //             $('#calendarContainer .fc-content-skeleton .fc-event-container .fc-content .fc-title').each(function(){
    //                 var  meeting_delivery = $(this).html()
    //                    if( meeting_delivery.includes('Dispatch') == true ){
    //                        $(this).parent().parent().show();
    //                    }else {
    //                        $(this).parent().parent().hide()
    //                    }
    ...
    //             $('#calendarContainer .fc-content-skeleton .fc-event-container .fc-content .fc-title').each(function(){
    //                 var  meeting_delivery = $(this).html()
    //                    if( meeting_delivery.includes('Arrival') == true ){
    //                        $(this).parent().parent().show();
    //                    }else {
    //                        $(this).parent().parent().hide()
    //                    }
    ...
    //             $('#calendarContainer .fc-content-skeleton .fc-event-container .fc-content .fc-title').each(function(){
    //                 var  meeting_delivery = $(this).html()
    //                    if( meeting_delivery.includes('Payment Due') == true ){
    //                        $(this).parent().parent().show();
    //                    }else {
    //                        $(this).parent().parent().hide()
    //                    }
