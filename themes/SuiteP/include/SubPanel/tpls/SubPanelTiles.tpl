...
<script>
    ...
    setTimeout(function() {
        ...
        //dung core -- hard code for automatically minimise sub module
        $("#subpanel_list li").each(function(index,value){
            if($(this).find('table tbody tr[class="footable-empty"]').length) {
