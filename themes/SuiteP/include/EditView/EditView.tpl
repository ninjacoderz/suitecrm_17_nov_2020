...
*}
<script src="custom/modules/Leads/autosize.min.js"></script>
<script src="themes/SuiteP/js/custom_global.js"></script>
{{sugar_include type="smarty" file=$headerTpl}}
{sugar_include include=$includes}
{*dung code - display link edit view*}
    <span>
        <strong>Absolute Path: </strong>
    </span>
    <span id="absolute_path">
        https://{$smarty.server.SERVER_NAME}/index.php?module={$module}&action=EditView&record={$fields.id.value}
    </span>
    <button type="button"  onclick="clip_aboard('absolute_path')">Copy Path</button>
...
{literal}
    ...
    //dung code - function clip_aboard

    function clip_aboard(absolute_path){
